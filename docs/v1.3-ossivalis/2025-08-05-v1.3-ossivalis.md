---
layout: post
title: 2025-08-05 - 67cbce3 ✅
parent: V1.3-OSSIVALIS
---


## InvokeCI: InvokeCI #304 - Commit [67cbce3](https://github.com/duckdb/duckdb/actions/runs/16737578110) (2025-08-05 00:43:33)
 Run succeeded
{: .label .label-green}
...
#### Latest run: [ 2025-08-05 00:43:33 ](https://github.com/duckdb/duckdb/actions/runs/16737578110)
...
> Nightly builds assets digest 256sha info can be found in the [checksum file](https://duckdb.github.io/duckdb-build-status/docs/v1.3-ossivalis/checksum/2025-08-05_checksum_v1.3-ossivalis.txt)