---
layout: post
title: 2025-07-19 - 473fd24 ❌
parent: V1.3-OSSIVALIS
---


## InvokeCI: InvokeCI #270 - Commit [473fd24](https://github.com/duckdb/duckdb/actions/runs/16382997529) (2025-07-19 00:40:35)
 Run failed
{: .label .label-red}
...
|:------------------------------------------------------------------------------------------------------------------|:----------------------------------|:--------------------|
| [osx / OSX Extensions Release (arm64)](https://github.com/duckdb/duckdb/actions/runs/16382997529/job/46298783492) | Test statically linked extensions | 2025-07-19 02:27:35 |
...
> Nightly builds assets digest 256sha info can be found in the [checksum file](https://duckdb.github.io/duckdb-build-status/docs/v1.3-ossivalis/checksum/2025-07-19_checksum_v1.3-ossivalis.txt)