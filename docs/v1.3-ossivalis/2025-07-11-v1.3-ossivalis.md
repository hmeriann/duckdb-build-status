---
layout: post
title: 2025-07-11 - f81bdf4 ❌
parent: V1.3-OSSIVALIS
---


## InvokeCI: InvokeCI #254 - Commit [f81bdf4](https://github.com/duckdb/duckdb/actions/runs/16209088961) (2025-07-11 00:40:51)
 Run failed
{: .label .label-red}
...
|:---------------------------------------------------------------------------------------------------------------------|:------------------|:--------------------|
| [Wasm / Linux Extensions (x64) (wasm_eh)](https://github.com/duckdb/duckdb/actions/runs/16209088961/job/45765674247) | Build Wasm module | 2025-07-11 00:42:48 |
...
> Nightly builds assets digest 256sha info can be found in the [checksum file](https://duckdb.github.io/duckdb-build-status/docs/v1.3-ossivalis/checksum/2025-07-11_checksum_v1.3-ossivalis.txt)