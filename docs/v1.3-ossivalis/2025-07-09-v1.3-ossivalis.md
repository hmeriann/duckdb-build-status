---
layout: post
title: 2025-07-09 - 3640d88 ❌
parent: V1.3-OSSIVALIS
---


## InvokeCI: InvokeCI #250 - Commit [3640d88](https://github.com/duckdb/duckdb/actions/runs/16157499210) (2025-07-09 00:40:53)
 Run failed
{: .label .label-red}
...
|:----------------------------------------------------------------------------------------------------------------------|:------------------|:--------------------|
| [Wasm / Linux Extensions (x64) (wasm_mvp)](https://github.com/duckdb/duckdb/actions/runs/16157499210/job/45602869917) | Build Wasm module | 2025-07-09 00:42:57 |
...
> Nightly builds assets digest 256sha info can be found in the [checksum file](https://duckdb.github.io/duckdb-build-status/docs/v1.3-ossivalis/checksum/2025-07-09_checksum_v1.3-ossivalis.txt)