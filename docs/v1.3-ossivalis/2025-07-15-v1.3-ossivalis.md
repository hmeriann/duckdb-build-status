---
layout: post
title: 2025-07-15 - de3e17e ❌
parent: V1.3-OSSIVALIS
---


## InvokeCI: InvokeCI #263 - Commit [de3e17e](https://github.com/duckdb/duckdb/actions/runs/16281181350) (2025-07-15 00:42:24)
 Run failed
{: .label .label-red}
...
|:---------------------------------------------------------------------------------------------------------------------|:------------------|:--------------------|
| [Wasm / Linux Extensions (x64) (wasm_eh)](https://github.com/duckdb/duckdb/actions/runs/16281181350/job/45971002011) | Build Wasm module | 2025-07-15 00:56:04 |
...
> Nightly builds assets digest 256sha info can be found in the [checksum file](https://duckdb.github.io/duckdb-build-status/docs/v1.3-ossivalis/checksum/2025-07-15_checksum_v1.3-ossivalis.txt)