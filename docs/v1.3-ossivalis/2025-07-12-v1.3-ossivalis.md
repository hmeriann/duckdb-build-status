---
layout: post
title: 2025-07-12 - f81bdf4 ❌
parent: V1.3-OSSIVALIS
---


## InvokeCI: InvokeCI #256 - Commit [f81bdf4](https://github.com/duckdb/duckdb/actions/runs/16232340388) (2025-07-12 00:41:15)
 Run failed
{: .label .label-red}
...
|:---------------------------------------------------------------------------------------------------------------------|:------------------|:--------------------|
| [Wasm / Linux Extensions (x64) (wasm_eh)](https://github.com/duckdb/duckdb/actions/runs/16232340388/job/45837430104) | Build Wasm module | 2025-07-12 00:44:26 |
...
> Nightly builds assets digest 256sha info can be found in the [checksum file](https://duckdb.github.io/duckdb-build-status/docs/v1.3-ossivalis/checksum/2025-07-12_checksum_v1.3-ossivalis.txt)