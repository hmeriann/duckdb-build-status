---
layout: post
title: 2025-07-13 - 7f75bfd ❌
parent: V1.3-OSSIVALIS
---


## InvokeCI: InvokeCI #259 - Commit [7f75bfd](https://github.com/duckdb/duckdb/actions/runs/16243638257) (2025-07-13 00:45:23)
 Run failed
{: .label .label-red}
...
|:--------------------------------------------------------------------------------------------------------------------------|:------------------|:--------------------|
| [Wasm / Linux Extensions (x64) (wasm_threads)](https://github.com/duckdb/duckdb/actions/runs/16243638257/job/45863353667) | Build Wasm module | 2025-07-13 00:47:25 |
...
> Nightly builds assets digest 256sha info can be found in the [checksum file](https://duckdb.github.io/duckdb-build-status/docs/v1.3-ossivalis/checksum/2025-07-13_checksum_v1.3-ossivalis.txt)