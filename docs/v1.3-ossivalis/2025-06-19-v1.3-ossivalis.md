---
layout: post
title: 2025-06-19 - 2063dda ❌
parent: V1.3-OSSIVALIS
---


## InvokeCI: InvokeCI #209 - Commit [2063dda](https://github.com/duckdb/duckdb/actions/runs/15746626071) (2025-06-19 00:39:41)
 Run failed
{: .label .label-red}
...
|:------------------------------------------------------------------------------------------------------------------|:----------------------------------------|:--------------------|
| [osx / OSX Extensions Release (arm64)](https://github.com/duckdb/duckdb/actions/runs/15746626071/job/44390742556) | Run /./.github/actions/build_extensions | 2025-06-19 04:24:46 |
...
> Nightly builds assets digest 256sha info can be found in the [checksum file](https://duckdb.github.io/duckdb-build-status/docs/v1.3-ossivalis/checksum/2025-06-19_checksum_v1.3-ossivalis.txt)