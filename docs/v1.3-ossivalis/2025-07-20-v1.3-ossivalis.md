---
layout: post
title: 2025-07-20 - a66af13 ❌
parent: V1.3-OSSIVALIS
---


## InvokeCI: InvokeCI #272 - Commit [a66af13](https://github.com/duckdb/duckdb/actions/runs/16394379835) (2025-07-20 00:46:17)
 Run failed
{: .label .label-red}
...
|:------------------------------------------------------------------------------------------------------------------|:----------------------------------|:--------------------|
| [osx / OSX Extensions Release (arm64)](https://github.com/duckdb/duckdb/actions/runs/16394379835/job/46325200666) | Test statically linked extensions | 2025-07-20 05:10:51 |
...
> Nightly builds assets digest 256sha info can be found in the [checksum file](https://duckdb.github.io/duckdb-build-status/docs/v1.3-ossivalis/checksum/2025-07-20_checksum_v1.3-ossivalis.txt)