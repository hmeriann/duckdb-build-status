---
layout: post
title: 2025-07-12 - fd3fa59 ❌
parent: MAIN
---


## InvokeCI: InvokeCI #257 - Commit [fd3fa59](https://github.com/duckdb/duckdb/actions/runs/16232340413) (2025-07-12 00:41:16)
 Run failed
{: .label .label-red}
...
|:------------------------------------------------------------------------------------------------------------------------------------|:------------------------------|:--------------------|
| [pyodide / Build pyodide wheel (3.13, 0.30.5, 22, true)](https://github.com/duckdb/duckdb/actions/runs/16232340413/job/45837430062) | install deps into environment | 2025-07-12 00:56:58 |
...
> Nightly builds assets digest 256sha info can be found in the [checksum file](https://duckdb.github.io/duckdb-build-status/docs/v1.3-ossivalis/checksum/2025-07-12_checksum_main.txt)