---
layout: post
title: 2025-08-17 - 2ed9bf8 ✅
parent: MAIN
---


## InvokeCI: InvokeCI #329 - Commit [2ed9bf8](https://github.com/duckdb/duckdb/actions/runs/17014723981) (2025-08-17 00:43:38)
 Run succeeded
{: .label .label-green}
...
#### Latest run: [ 2025-08-17 00:43:38 ](https://github.com/duckdb/duckdb/actions/runs/17014723981)
...
> Nightly builds assets digest 256sha info can be found in the [checksum file](https://duckdb.github.io/duckdb-build-status/docs/v1.3-ossivalis/checksum/2025-08-17_checksum_main.txt)