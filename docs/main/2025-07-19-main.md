---
layout: post
title: 2025-07-19 - e958b05 ❌
parent: MAIN
---


## InvokeCI: InvokeCI #271 - Commit [e958b05](https://github.com/duckdb/duckdb/actions/runs/16382997579) (2025-07-19 00:40:35)
 Run failed
{: .label .label-red}
...
|:------------------------------------------------------------------------------------------------------------------|:----------------------------------|:--------------------|
| [osx / OSX Extensions Release (arm64)](https://github.com/duckdb/duckdb/actions/runs/16382997579/job/46298884185) | Test statically linked extensions | 2025-07-19 04:57:04 |
...
> Nightly builds assets digest 256sha info can be found in the [checksum file](https://duckdb.github.io/duckdb-build-status/docs/v1.3-ossivalis/checksum/2025-07-19_checksum_main.txt)