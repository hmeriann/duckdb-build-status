---
layout: post
title: 2025-08-25 - 22e6d1e ✅
parent: MAIN
---


## InvokeCI: InvokeCI #345 - Commit [22e6d1e](https://github.com/duckdb/duckdb/actions/runs/17195982949) (2025-08-25 00:39:50)
 Run succeeded
{: .label .label-green}
...
#### Latest run: [ 2025-08-25 00:39:50 ](https://github.com/duckdb/duckdb/actions/runs/17195982949)
...
> Nightly builds assets digest 256sha info can be found in the [checksum file](https://duckdb.github.io/duckdb-build-status/docs/v1.3-ossivalis/checksum/2025-08-25_checksum_main.txt)