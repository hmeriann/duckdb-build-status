---
layout: post
title: 2025-08-16 - 2ed9bf8 ✅
parent: MAIN
---


## InvokeCI: InvokeCI #327 - Commit [2ed9bf8](https://github.com/duckdb/duckdb/actions/runs/17002161129) (2025-08-16 00:37:58)
 Run succeeded
{: .label .label-green}
...
#### Latest run: [ 2025-08-16 00:37:58 ](https://github.com/duckdb/duckdb/actions/runs/17002161129)
...
> Nightly builds assets digest 256sha info can be found in the [checksum file](https://duckdb.github.io/duckdb-build-status/docs/v1.3-ossivalis/checksum/2025-08-16_checksum_main.txt)