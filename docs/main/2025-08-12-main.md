---
layout: post
title: 2025-08-12 - d0e1817 ✅
parent: MAIN
---


## InvokeCI: InvokeCI #319 - Commit [d0e1817](https://github.com/duckdb/duckdb/actions/runs/16895774766) (2025-08-12 00:39:44)
 Run succeeded
{: .label .label-green}
...
#### Latest run: [ 2025-08-12 00:39:44 ](https://github.com/duckdb/duckdb/actions/runs/16895774766)
...
> Nightly builds assets digest 256sha info can be found in the [checksum file](https://duckdb.github.io/duckdb-build-status/docs/v1.3-ossivalis/checksum/2025-08-12_checksum_main.txt)