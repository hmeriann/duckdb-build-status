---
layout: post
title: 2025-07-20 - e958b05 ❌
parent: MAIN
---


## InvokeCI: InvokeCI #273 - Commit [e958b05](https://github.com/duckdb/duckdb/actions/runs/16394379849) (2025-07-20 00:46:17)
 Run failed
{: .label .label-red}
...
|:------------------------------------------------------------------------------------------------------------------|:----------------------------------|:--------------------|
| [osx / OSX Extensions Release (arm64)](https://github.com/duckdb/duckdb/actions/runs/16394379849/job/46325054772) | Test statically linked extensions | 2025-07-20 02:18:04 |
...
> Nightly builds assets digest 256sha info can be found in the [checksum file](https://duckdb.github.io/duckdb-build-status/docs/v1.3-ossivalis/checksum/2025-07-20_checksum_main.txt)