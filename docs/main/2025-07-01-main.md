---
layout: post
title: 2025-07-01 - 3b9012f ❌
parent: MAIN
---


## InvokeCI: InvokeCI #234 - Commit [3b9012f](https://github.com/duckdb/duckdb/actions/runs/15986920908) (2025-07-01 00:45:23)
 Run failed
{: .label .label-red}
...
|:------------------------------------------------------------------------------------------------------------------|:--------|:--------------------|
| [python / twine-upload / Twine upload](https://github.com/duckdb/duckdb/actions/runs/15986920908/job/45112715943) | Deploy  | 2025-07-01 08:22:42 |
...
> Nightly builds assets digest 256sha info can be found in the [checksum file](https://duckdb.github.io/duckdb-build-status/docs/v1.3-ossivalis/checksum/2025-07-01_checksum_main.txt)