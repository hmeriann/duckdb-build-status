---
layout: post
title: 2025-07-02 - 977e76d ❌
parent: MAIN
---


## InvokeCI: InvokeCI #236 - Commit [977e76d](https://github.com/duckdb/duckdb/actions/runs/16013299706) (2025-07-02 00:39:44)
 Run failed
{: .label .label-red}
...
|:------------------------------------------------------------------------------------------------------------------|:--------|:--------------------|
| [python / twine-upload / Twine upload](https://github.com/duckdb/duckdb/actions/runs/16013299706/job/45193180955) | Deploy  | 2025-07-02 08:07:15 |
...
> Nightly builds assets digest 256sha info can be found in the [checksum file](https://duckdb.github.io/duckdb-build-status/docs/v1.3-ossivalis/checksum/2025-07-02_checksum_main.txt)